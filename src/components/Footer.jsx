    ...
    <footer className="bg-dark">
      <div className="container d-flex justify-content-between align-items-center px-3 py-2">
        ...
        <div className="d-flex justify-content-center align-items-center gap-3">
          <a href="https://github.com/bora-sen/web-eqsl-creator" title={t("seeTheSourceCode")} className="text-decoration-none text-black">
            <svg width="24px" fill="white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="text-center text-white text-opacity-50 pe-none">
        <span>made with &#10084;</span>
      </div>
    </footer>
  )
